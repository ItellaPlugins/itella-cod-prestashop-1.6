...
class ItellaCod extends PaymentModule
{
	private $_prefix = 'ITELLACOD_';
	...
	public function install()
	{
		...
		Configuration::updateValue('ITELLACOD_STATUS', '1');
		return true;
	}
		...
		$fieldsForm[0]['form'] = [
			...
			'input' => array(
				...
				array(
					...
					'name' => 'ITELLACOD_FEE_FLAT',
					'size' => 20
				),
				array(
					'type' => 'text',
					'label' => $this->l('% fee'),
					'name' => 'ITELLACOD_FEE_PERC',
					'size' => 20,
				),
				array(
					'type' => 'html',
					'label' => $this->l('Order total:'),
					'name' => 'itellacod_enable_html',
					'html_content' => '',
				),
				array(
					'type' => 'text',
					'label' => $this->l('MIN'),
					'name' => 'ITELLACOD_TOTAL_MIN',
					'size' => 20,
				),
				array(
					'type' => 'text',
					'label' => $this->l('MAX'),
					'name' => 'ITELLACOD_TOTAL_MAX',
					'size' => 20,
				...
				array(
					'type' => 'html',
					'label' => '',
					'name' => 'itellacod_carriers_html',
					'html_content' => '',
				),
				array(
					'type' => 'checkbox',
					'label' => $this->l('Shipping carriers'),
					'name' => 'ITELLACOD_CARRIERS',
					'desc' => $this->l('Select shipping carriers to use Itella COD with. Select none to enable for all.'),
					'values' => array(
						'query' => $carriers,
						'id' => 'id_reference',
						'name' => 'name'
